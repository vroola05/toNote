...
export class TabMenu {
    ...
    constructor(name:string, classes:string|undefined){
		...
		domAdd.innerHTML = "<span class='icon'>+</span><span class='text'>" + name + "</span><div>"
    ...
    private setActive(identifier:number) : void{
